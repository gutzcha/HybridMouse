...
Variables in table:
        ...
        function ret = autoDetect(obj,data,net,param)
            ...
            if isfield(param,'y_lim')
                y_lim = param.y_lim;
                obj.lastDetectionParameters.y_lim = y_lim;
            else
                y_lim = obj.lastDetectionParameters.y_lim;
            end
            
            ret = extract_features_from_large_filesWraper(...
                data,startTime,definedFilter,net,displayProgressFlag,fsRate,th,smoothingK,label,[],y_lim) ;
